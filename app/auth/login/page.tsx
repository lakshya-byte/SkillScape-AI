    ...
    <div className="relative w-full min-h-screen bg-[#050508] text-white overflow-hidden selection:bg-purple-500/30 font-sans">
      ...
      <div className="absolute top-8 left-8 md:top-10 md:left-10 z-20 opacity-70">
        <div className="flex flex-col gap-1">
          <h1 className="text-xs font-bold tracking-widest text-white uppercase">VelionAI System Access</h1>
          <div className="text-[9px] font-mono text-purple-400 uppercase tracking-wider">Secure Authentication Portal</div>
          <div className="text-[9px] font-mono text-slate-600 uppercase">ID: X-9920 X // NODE: ALPHA</div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 right-8 md:bottom-10 md:right-10 z-20 text-right opacity-70 hidden md:block">
        <div className="flex flex-col items-end gap-1">
          <div className="flex items-center gap-2">
             ...
             <span className="text-[9px] font-bold tracking-widest text-emerald-500 uppercase">Auth Node Active</span>
          </div>
          <div className="text-[9px] font-mono text-slate-600 uppercase">Encryption: AES-256-GCM</div>
          <div className="text-[9px] font-mono text-slate-600 uppercase">Latency: 12ms</div>
        </div>
        ...
        >
          ...
          <div className="relative bg-[#0A0A0F]/90 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 md:p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden">
             ...
             <div className="text-center mb-10">
               ...
               <h2 className="text-2xl font-bold text-white mb-2 tracking-tight">Access Your Intelligence</h2>
             ...
             <form onSubmit={handleLogin} className="space-y-5">
               ...
               <div className="space-y-1.5">
                 <div className="flex justify-between items-center pl-1 pr-1">
                    ...
                    <button type="button" className="text-[10px] font-bold text-purple-400 hover:text-purple-300 transition-colors">
                      Forgot key?
                    </button>
                 </div>
                 <div className="relative group">
             ...
             <div className="relative my-8">
               ...
               <div className="relative flex justify-center text-[9px] uppercase tracking-widest">
                 <span className="bg-[#0D0D12] px-3 text-slate-600 font-mono">System Link</span>
               </div>
             </div>

             {/* Social Login */}
             <div className="flex gap-4 mb-8">
               <button className="flex-1 py-2.5 rounded-full bg-[#1A1A23] border border-white/5 hover:bg-[#20202A] hover:border-white/10 transition-all flex items-center justify-center gap-2 text-slate-300 hover:text-white text-xs font-bold">
                 <Github size={16} />
                 <span>GitHub</span>
               </button>
               <button className="flex-1 py-2.5 rounded-full bg-[#1A1A23] border border-white/5 hover:bg-[#20202A] hover:border-white/10 transition-all flex items-center justify-center gap-2 text-slate-300 hover:text-white text-xs font-bold">
             ...
             <div className="text-center">
               <p className="text-xs text-slate-500">
                 New to VelionAI?{' '}
                 <Link href="/onboarding" className="text-purple-400 font-bold hover:text-purple-300 transition-colors">
                   Initialize Profile
                 </Link>
               </p>
             </div>
