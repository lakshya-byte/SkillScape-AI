  ...
  nodes: [
    {
      id: "prj_velionai",
      name: "VelionAI",
      description: "Enterprise SaaS Intelligence Platform.",
      githubUrl: "https://github.com/lakshya/velionai",
      stars: 45,
      commitCount: 1250,
    ...
    },
    {
      id: "prj_krishinetra",
      name: "KrishiNetra",
      description: "Android mobile application utilizing MVVM.",
      githubUrl: "https://github.com/lakshya/krishinetra",
      stars: 82,
      commitCount: 840,
    ...
    },
    {
      id: "prj_ncs",
      name: "NCS Website",
      description: "Official web platform for the Nibble Computer Society.",
      githubUrl: "https://github.com/lakshya/ncs-website",
      stars: 120,
      commitCount: 620,
    ...
    },
    {
      id: "prj_formify",
      name: "Formify",
      description: "Dynamic form generation engine.",
      githubUrl: "https://github.com/lakshya/formify",
      stars: 34,
      commitCount: 410,
    ...
    },
    {
      id: "prj_summarease",
      name: "SummarEase",
      description: "Automated NLP-based text summarization.",
      githubUrl: "https://github.com/lakshya/summarease",
      stars: 15,
      commitCount: 180,
  ...
  const handleNodeHover = useCallback(
    (node: ProjectNode | null) => {
      ...
      if (node) {
        ...
        nodeNeighbors
          .get(node.id)
          ?.forEach((neighborId) => newHighlightNodes.add(neighborId));
      }
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              ...
              <span
                ...
                style={{
                  backgroundColor: `${statusColors[hoverNode.status]}20`,
                  color: statusColors[hoverNode.status],
                }}
              >
                {hoverNode.status}
              </span>
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-white/10 pt-4">
              <div className="flex flex-col">
                ...
                <span className="text-sm font-medium text-gray-200">
                  {hoverNode.commitCount}
                </span>
              </div>
              <div className="flex flex-col">
                <span className="text-xs text-gray-500 flex items-center">
                  <Activity className="w-3 h-3 mr-1" /> Complexity
                </span>
                <span className="text-sm font-medium text-gray-200">
                  {hoverNode.complexityScore}/100
                </span>
              </div>
              <div className="flex flex-col">
                <span className="text-xs text-gray-500 flex items-center">
