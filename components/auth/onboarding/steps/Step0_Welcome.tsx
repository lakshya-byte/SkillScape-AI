  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Fingerprint Icon */}
        <div
          className={`p-2 rounded-full bg-purple-500/10 text-purple-400 transition-colors duration-300 ${isHovering ? "bg-purple-500 text-white" : ""}`}
        >
      ...
      {/* 5. FOOTER HINT */}
      <motion.div
        className="mt-8 text-[10px] text-slate-600 font-mono"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
