  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (p >= 100) {
        ...
        // Redirect after completion (Simulated)
        setTimeout(() => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative">
      ...
      <div className="absolute top-0 right-0 flex items-center gap-2">
         <span className="text-[10px] font-mono text-slate-500 tracking-widest uppercase">INITIALIZATION_MODE</span>
      ...
      <div className="relative w-[320px] h-[320px] md:w-[400px] md:h-[400px] flex items-center justify-center mb-16">
        ...
        <div className="absolute left-[-40px] top-1/2 -translate-y-1/2 flex items-center gap-2 opacity-60 hidden md:flex">
           <div className="text-right">
             <div className="text-[9px] font-mono text-purple-400 uppercase tracking-wider">Encryption</div>
             <div className="text-[9px] font-mono text-slate-500 uppercase">AES-256-GCM</div>
           </div>
        ...
        <div className="absolute right-[-40px] top-[30%] flex items-center gap-2 opacity-60 hidden md:flex">
           ...
           <div className="text-left">
             <div className="text-[9px] font-mono text-cyan-400 uppercase tracking-wider">MEM_ALLOC</div>
             <div className="text-[9px] font-mono text-slate-500 uppercase">4096 TB</div>
           </div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center">
            <div className="w-20 h-20 mb-4 text-white animate-float">
               <Box strokeWidth={0.5} className="w-full h-full text-purple-200 opacity-80" />
            ...
            <div className="text-6xl font-bold text-white tracking-tighter tabular-nums">
              {Math.round(progress)}<span className="text-2xl text-purple-400">%</span>
            </div>
        </div>
      </div>
      ...
      <div className="text-center mb-12 max-w-2xl px-4">
         ...
         >
           Initializing neural pathways and calibrating data models. Please wait <br className="hidden md:block"/>
          ...
          return (
            ...
            >
              ...
              <div className={`p-2 rounded-full transition-colors duration-300 ${
                  state === 'done' ? 'text-emerald-400 bg-emerald-500/10' :
                  state === 'active' ? 'text-purple-400 bg-purple-500/10' :
              ...
              <div>
                ...
                <div className={`text-[10px] font-mono uppercase ${
                  ...
                  {state === 'done' ? 'VERIFIED' : state === 'active' ? stage.sub : 'WAITING'}
                </div>
              </div>
            </div>
          );
